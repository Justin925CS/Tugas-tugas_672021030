...
import tas_pbog_672021030.Login;
/**
 *
 * @author Lenovo
 */
public class FrameLogin extends javax.swing.JFrame {
    ...
    private void LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginActionPerformed
        try {
            PreparedStatement stm = con.prepareStatement("SELECT * FROM user where Username ='"+Username.getText()+"'AND Password='"+Password.getText()+"'");
